const CACHE='monumania-v2-stable-motion';
const ASSETS=['./','./index.html','./styles.css','./app.mjs','./engine.mjs','./data.mjs','./favicon.svg','./manifest.webmanifest','./assets/atlas-background.png','./assets/monuments-sprite.png'];
